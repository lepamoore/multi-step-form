...
import './PlanToSelect.css';

class PlanToSelect extends React.Component {
    constructor(props) {
        super(props);

        this.svgToRender = this.svgToRender.bind(this);
    }

    svgToRender() {
        if(this.props.planHeading === 'Arcade') {
            return (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="planSvg">
        ...
        } else if(this.props.planHeading === 'Advanced') {
            return (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="planSvg">
        ...
        } else if(this.props.planHeading === 'Pro') {
            return (
                <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="planSvg">
    ...
    render() {
        return(
            <div className="PlanToSelectWrapper" 
            tabIndex={0} 
            id={this.props.planHeading} 
            onFocus={this.props.handlePlanSelect}
            style={{backgroundColor: this.props.bgColor, borderColor: this.props.brColor}} >
                {this.svgToRender()}
                <div className="allDetailsContainer">
                    <div className="planDetailsContainer">
                        <h2 className="planName">{this.props.planHeading}</h2>
                        <p className="planPrice" id={`${this.props.planHeading}Price`}>{`$${this.props.planPrice}/mo`}</p>
                    </div>
                    <div id={`${this.props.planHeading}GhostDiv`} className='ghostDivs'>
                        <span className="freeMonths" id={`${this.props.planHeading}FreeMonths`}>2 monts free</span>
                    </div>
                </div>
            </div>
        );
